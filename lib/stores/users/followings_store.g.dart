...
mixin _$FollowingsStore on _FollowingsStore, Store {
  final _$usersAtom = Atom(name: '_FollowingsStore.users');
  ...
  final _$pageAtom = Atom(name: '_FollowingsStore.page');
  ...
  final _$hasReachedEndAtom = Atom(name: '_FollowingsStore.hasReachedEnd');
