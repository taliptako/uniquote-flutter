...
mixin _$MostLikedStore on _MostLikedStore, Store {
  final _$quotesAtom = Atom(name: '_MostLikedStore.quotes');
  ...
  final _$pageAtom = Atom(name: '_MostLikedStore.page');
